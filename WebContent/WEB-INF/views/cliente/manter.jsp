		...
		<div class="row">
			...
			<div class="col-xs-12">
				...
				<div class="box box-primary">
					...
					<!-- /.box-header -->
					<!-- form start -->
					<form class="form-horizontal" action="manterCliente">
						<div class="box-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="cnpj" name="cnpj"
										placeholder="CNPJ" value="${cliente.cnpj}">
								</div>
							</div>
						</div>
						<!-- /.box-body -->
...
<c:if test="${not empty mensagem}">
			<div class="alert alert-danger alert-dismissable">
				...
				<div class="box box-primary">
					...
					<div class="box-footer">
						<a style="${not empty cliente.id ? 'display:block' : 'display:none'}" class="btn btn-primary pull-right" href="cadastrarEndereco">Cadastrar novo</a>
					</div>
					<!-- /.box-footer -->
